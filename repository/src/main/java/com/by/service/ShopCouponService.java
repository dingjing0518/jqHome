...
public interface ShopCouponService {
	...
	Page<ShopCoupon> findAllByValidAndDateBetweenAndNameLike(ValidEnum valid, Calendar calendar, String name,
			Pageable pageable);
	...
	ShopCoupon cachePut(ShopCoupon coupon);
	
	ShopCoupon refresh(int id);
}
