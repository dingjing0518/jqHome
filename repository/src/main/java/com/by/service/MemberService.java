...
public interface MemberService {
	...
	Member minusScoreAll(Member member, int total, String reason, ScoreHistoryEnum type);
	
	Member minusScoreAll(Member member, int total, String reason, ScoreHistoryEnum type, String remark);

	Member addScore(Member member, int total, String reason, ScoreHistoryEnum type);
	
	Member addScore(Member member, int total, String reason, ScoreHistoryEnum type, String remark);
